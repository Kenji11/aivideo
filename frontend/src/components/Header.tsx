  ...
  return (
    <nav className="bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 sticky top-0 z-50 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center space-x-2 cursor-pointer group" onClick={onProjectsClick}>
            ...
            <div>
              ...
              <span className="text-xs text-slate-500 dark:text-slate-400 block">Studio</span>
            </div>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-4">
            <button
              ...
              className="text-sm font-medium text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-slate-100 px-4 py-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors"
            >
              My Projects
            </button>
            {userName && (
        ...
        {mobileMenuOpen && (
          <div className="md:hidden pb-4 space-y-2 border-t border-slate-200 dark:border-slate-700 pt-4 animate-slide-in">
            <button
              onClick={onProjectsClick}
              className="w-full text-left text-sm font-medium text-slate-700 dark:text-slate-300 px-4 py-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors"
            >
              My Projects
            </button>
            {userName && (
              <>
                ...
                <button
                  onClick={onLogout}
                  className="w-full text-left text-sm font-medium text-slate-700 dark:text-slate-300 px-4 py-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors flex items-center space-x-2"
                >
