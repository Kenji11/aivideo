    ...
    <div className="card overflow-hidden hover:shadow-lg group cursor-pointer animate-fade-in">
      ...
      <div className="p-4 space-y-3">
        ...
        <button
          ...
          className="w-full text-sm text-slate-500 hover:text-red-600 hover:bg-red-50 py-2 rounded-lg transition-colors flex items-center justify-center space-x-1"
        >
